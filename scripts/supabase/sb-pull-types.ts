...
export type SchemaName = '${env.SB_SCHEMA}';
export const schemaName: SchemaName = '${env.SB_SCHEMA}';`.trim()
	);
	...
	const zodSchemaString = generateZodSchemaString(contents, env.SB_SCHEMA);
