...
export function generateZodSchemaString(tsCode: string): string {
	...
	function parseTypeLiteralToZod(obj: ts.TypeNode): Record<string, string> {
		...
		obj.members.forEach((member) => {
			...
			else if (typeText.includes('Json')) zodType = 'z.unknown()';
...
`
	...
	console.log('Supabase types and Zod schemas generated successfully.');
	console.log(
		'View the generated types at src/lib/types/supabase.ts and the generated Zod schemas at src/lib/types/supabase-zod.ts'
	);
};
