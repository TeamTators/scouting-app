...
export type SchemaName = '${sb.schema}';
export const schemaName: SchemaName = '${sb.schema}';`.trim()
	);
	// Generate the supabase types
	let contents = await runTask(
		{
			SUPABASE_DB_PASSWORD: sb.postgres_password
		},
		'npx',
		'supabase',
		'gen',
	...
	const zodSchemaString = generateZodSchemaString(contents, sb.schema);
