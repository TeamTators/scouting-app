...
<Portal target="body">
   <div bind:this={self} {id} class="modal fade custom-modal" aria-modal="true" role="dialog" tabindex="-1">
			   ...
			   <div class="modal-header custom-modal-header">
				   ...
				   >
					   <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
						   <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.75.75 0 1 1 1.06 1.06L9.06 8l3.22 3.22a.75.75 0 1 1-1.06 1.06L8 9.06l-3.22 3.22a.75.75 0 1 1-1.06-1.06L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06z" fill="currentColor"/>
					   </svg>
				   </button>
			   </div>
...
.custom-modal-content {
	border-radius: 12px;
	box-shadow: 0 8px 32px rgba(31, 35, 40, 0.18), 0 1.5px 4px rgba(31, 35, 40, 0.04);
