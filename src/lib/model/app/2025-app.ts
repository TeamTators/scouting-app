...
import { type Action2025, type TraceParse2025, type Zones2025 } from 'tatorscout/trace';
import { App } from './app';
 ...
 */
export const generate2025App = (matchData: {
	matches: TBAMatch[];
	match: number;
	team: number;
	compLevel: CompLevel;
	...
	for (const key in images) {
		images[key as keyof typeof images].src = `/public/pictures/icons/${key}.png`;
		images[key as keyof typeof images].classList.add('no-select');
		images[key as keyof typeof images].ondragstart = (e) => e.preventDefault();
		images[key as keyof typeof images].onselectstart = (e) => e.preventDefault();
		images[key as keyof typeof images].oncontextmenu = (e) => e.preventDefault();
		images[key as keyof typeof images].onmousedown = (e) => e.preventDefault();
		images[key as keyof typeof images].ondrag = (e) => e.preventDefault();
	}

	const app = new App<Action2025, Zones2025, TraceParse2025>(2025, icons, matchData);
	...
	app.addAppObject(
		[0.36, 0.95],
		new I('Blue Processor', 'Placing any algae into the blue processor', 'prc', 0),
		bluePrc,
		(i) => i.toString(),
		'blue'
	);
	...
	app.addAppObject(
		[0.64, 0.05],
		new I('Red Processor', 'Placing any algae into the red processor', 'prc', 0),
		redPrc,
		(i) => i.toString(),
		'red'
	);
	...
	app.addAppObject(
		[0.733, 0.6],
		new I('Red Coral Level 1', 'Placing any coral into the Red coral level 1', 'cl1', 0),
		redCL1,
		(i) => i.toString(),
		'red'
	);
	app.addAppObject(
		[0.733, 0.5333],
		new I('Red Coral Level 2', 'Placing any coral into the Red coral level 2', 'cl2', 0),
		redCL2,
		(i) => i.toString(),
		'red'
	);
	app.addAppObject(
		[0.733, 0.4667],
		new I('Red Coral Level 3', 'Placing any coral into the red coral level 3', 'cl3', 0),
		redCL3,
		(i) => i.toString(),
		'red'
	);
	app.addAppObject(
		[0.733, 0.4],
		new I('Red Coral Level 4', 'Placing any coral into the Red coral level 4', 'cl4', 0),
		redCL4,
		(i) => i.toString(),
		'red'
	);
	...
	app.addAppObject(
		[0.267, 0.6],
		new I('Blue Coral Level 1', 'Placing any coral into the blue coral level 1', 'cl1', 0),
		blueCL1,
		(i) => i.toString(),
		'blue'
	);
	app.addAppObject(
		[0.267, 0.5333],
		new I('Blue Coral Level 2', 'Placing any coral into the blue coral level 2', 'cl2', 0),
		blueCL2,
		(i) => i.toString(),
		'blue'
	);
	app.addAppObject(
		[0.267, 0.4667],
		new I('Blue Coral Level 3', 'Placing any coral into the blue coral level 3', 'cl3', 0),
		blueCL3,
		(i) => i.toString(),
		'blue'
	);
	app.addAppObject(
		[0.267, 0.4],
		new I('Blue Coral Level 4', 'Placing any coral into the blue coral level 4', 'cl4', 0),
		blueCL4,
		(i) => i.toString(),
		'blue'
	);
