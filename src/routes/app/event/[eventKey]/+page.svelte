    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="grid">
                        {#each matches as match}
                            <a href="/app/event/{eventKey}/match/{match.comp_level}/{match.match_number}" class="grid-item btn btn-secondary">
        ...
        <div class="col-md-6">
            <div class="container-fluid">
                <div class="row">
                    <div class="input-group mb-3">
                        <input type="number" class="form-control" bind:value={team} placeholder="Enter team number" onkeydown={(e) => {
                            if (e.key === 'Enter') {
                ...
                <div class="row">
                    <div class="grid">
                        {#each teams as team}
                            <a href="/app/event/{eventKey}/team/{team.team_number}" class="grid-item btn btn-secondary">
                                {team.team_number}
                            </a>
                        {/each}
                    </div>
