...
\restrict xKvDVujMZdCAI4RjNvNJhbeGsQfaY1YwukHM6i38XkGUAW8NbgjEKgPT67UG1ry
...
CREATE ROLE check_027c548;
ALTER ROLE check_027c548 WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
CREATE ROLE check_65397d5;
ALTER ROLE check_65397d5 WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
CREATE ROLE check_7b9423c;
ALTER ROLE check_7b9423c WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
CREATE ROLE dashboard_user;
ALTER ROLE dashboard_user WITH NOSUPERUSER INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
CREATE ROLE docker_test_7b9423c;
ALTER ROLE docker_test_7b9423c WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
CREATE ROLE e2e_test_7b9423c;
ALTER ROLE e2e_test_7b9423c WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
...
CREATE ROLE test_schema;
ALTER ROLE test_schema WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
CREATE ROLE unit_test_7b9423c;
ALTER ROLE unit_test_7b9423c WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
...
\unrestrict xKvDVujMZdCAI4RjNvNJhbeGsQfaY1YwukHM6i38XkGUAW8NbgjEKgPT67UG1ry
