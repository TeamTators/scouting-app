...
\restrict vx8OcJSJeK5z8hw3QZbkQO33xXbusmq7mTn9gY1CHr4iTL9SpgEAbF5jcvRg6Rl
...
--
-- Name: enable_schema_realtime(text); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION public.enable_schema_realtime(target_schema text) RETURNS void
...
ALTER FUNCTION public.enable_schema_realtime(target_schema text) OWNER TO supabase_admin;

--
-- Name: rls_auto_enable(); Type: FUNCTION; Schema: public; Owner: supabase_admin
--
...
--
-- Name: messages Allow pushing broadcasts for authenticated users only; Type: POLICY; Schema: realtime; Owner: supabase_realtime_admin
--

CREATE POLICY "Allow pushing broadcasts for authenticated users only" ON realtime.messages FOR INSERT TO anon WITH CHECK ((extension = 'broadcast'::text));
...
--
-- Name: FUNCTION enable_schema_realtime(target_schema text); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION public.enable_schema_realtime(target_schema text) TO postgres;
GRANT ALL ON FUNCTION public.enable_schema_realtime(target_schema text) TO anon;
GRANT ALL ON FUNCTION public.enable_schema_realtime(target_schema text) TO authenticated;
GRANT ALL ON FUNCTION public.enable_schema_realtime(target_schema text) TO service_role;


--
-- Name: FUNCTION rls_auto_enable(); Type: ACL; Schema: public; Owner: supabase_admin
--
...
\unrestrict vx8OcJSJeK5z8hw3QZbkQO33xXbusmq7mTn9gY1CHr4iTL9SpgEAbF5jcvRg6Rl
